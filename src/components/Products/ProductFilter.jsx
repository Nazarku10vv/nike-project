		...
		<Box id='side_bar'>
			<Box className='side_bar'>
				...
				>
					...
					>
						{more === 4
							? priceArr.slice(0, 4).map((i, index) => (
									<ListItem
										key={index}
										sx={{
											fontSize: '16px',
						...
						{more === 4 ? (
							<ListItem
								onClick={() => setMore(priceArr.length)}
								sx={{
									fontSize: '16px',
									p: 0,
									m: 0,
				...
				>
					...
					>
						{/*  */}
						{more === 4
							? athletesArr.slice(0, 4).map((i, index) => (
									<ListItem
										key={index}
										sx={{
											fontSize: '16px',
						...
						{more === 4 ? (
							<ListItem
								onClick={() => setMore(athletesArr.length)}
								sx={{
									fontSize: '16px',
									p: 0,
									m: 0,
				...
				>
					...
					>
						...
						{more === 4
							? technologyArr.slice(0, 4).map((i, index) => (
									<ListItem
										key={index}
										sx={{
											fontSize: '16px',
						...
						{more === 4 ? (
							<ListItem
								onClick={() => setMore(technologyArr.length)}
								sx={{
									fontSize: '16px',
									p: 0,
									m: 0,
				...
				>
					...
					>
						...
						{more === 4
							? surfaceArr.slice(0, 4).map((i, index) => (
									<ListItem
										key={index}
										sx={{
											fontSize: '16px',
						...
						{more === 4 ? (
							<ListItem
								onClick={() => setMore(surfaceArr.length)}
								sx={{
									fontSize: '16px',
									p: 0,
									m: 0,
